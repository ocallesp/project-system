...
namespace Microsoft.VisualStudio.ProjectSystem.VS.References
{
    public class ReferenceCleanupServiceTests
    {
        ...
        [Fact]
        public async void GetProjectReferencesAsync_FoundReferences_ReturnAllReferences()
        {
            var referenceCleanupService = Setup();
            ...
            out IImmutableDictionary<string, IImmutableDictionary<string, string>> assemblyItems, out IImmutableDictionary<string, IImmutableDictionary<string, string>> sdkItems)
        {
            ...
            packageItems = new Dictionary<string, IImmutableDictionary<string, string>>
            {
                ...
                {
                    _package2,
                    new Dictionary<string, string> {{"TreatAsUsed", "True"}, {"Name", _package2}}.ToImmutableDictionary()
                },
                {
                    _package3,
                    new Dictionary<string, string> {{"TreatAsUsed", "True"}, {"Name", _package3}}.ToImmutableDictionary()
                }
            }.ToImmutableDictionary();
        ...
        {
            System.Predicate<IProjectVersionedValue<IProjectSubscriptionUpdate>> predicate = null;
        ...
        {
            private IProjectVersionedValue<IProjectSubscriptionUpdate> _item;
